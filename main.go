...
func parseContent(input []byte, tFname string) ([]byte, error) {
	...
	defaultTemplate, err := os.ReadFile("defaultTemplate.html")
	if err != nil {
		return nil, err
	}
	defaultTemplateStr := string(defaultTemplate)
	...
	t, err := template.New("mdp").Parse(defaultTemplateStr)
	if err != nil {
		return nil, err
	}
	...
	// Create a buffore of bytes to write to file
...
func preview(fname string) error {
	...
	// Give the browser some time to open the file before delting it
